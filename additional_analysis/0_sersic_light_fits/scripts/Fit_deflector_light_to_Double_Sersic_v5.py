...
def get_mask(large_image, bkg_rms, lens_name,mask_index = 0,kernel_size=11,mask_radius=None):
  ...
  #  central_id = list(s)[np.argsort(np.max(area, axis=0))[-2]]+1
    ...
    if survey=='SLACS':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SLACS/double_sersic/plots/{}_mask.png".format(lens_name))
    elif survey=='SL2S':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SL2S/double_sersic/plots/{}_mask.png".format(lens_name))
    elif survey=='BELLS':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/BELLS/double_sersic/plots/{}_mask.png".format(lens_name))
    else:
        raise("Bad Survey")
    plt.show()
...
#                              bands_compute=None)
    ...
    if survey=='SLACS':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SLACS/double_sersic/plots/{}_model_{:.2f}.png".format(lens_name,logL))
    elif survey=='SL2S':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SL2S/double_sersic/plots/{}_model_{:.2f}.png".format(lens_name,logL))
    elif survey=='BELLS':
        plt.savefig("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/BELLS/double_sersic/plots/{}_model_{:.2f}.png".format(lens_name,logL))
...
def Sersic_Fitter(lens_name,mask_index=0,kernel_size=10,mask_radius=None):
    ...
    if True:
     ...
     #       f = h5py.File(local_data_filename, "r")
        ...
        if survey =='SLACS':
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SLACS/double_sersic/models/{}_results".format(lens_name),kwargs_result)
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SLACS/double_sersic/models/{}_chains".format(lens_name),chain_list)
        elif survey =='SL2S':
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SL2S/double_sersic/models/{}_results".format(lens_name),kwargs_result)
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/SL2S/double_sersic/models/{}_chains".format(lens_name),chain_list)
        elif survey =='BELLS':
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/BELLS/double_sersic/models/{}_results".format(lens_name),kwargs_result)
            np.save("/home/s1/chinyi/80bdata/dinos/Sersic_Fitter/v2/BELLS/double_sersic/models/{}_chains".format(lens_name),chain_list)            
